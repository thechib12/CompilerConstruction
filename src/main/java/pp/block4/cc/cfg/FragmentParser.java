...
public class FragmentParser extends Parser {
    ...
    public static class ProgramContext extends ParserRuleContext {
        ...
        public TerminalNode EOF() {
            return getToken(FragmentParser.EOF, 0);
        }
    ...
    public static class IfStatContext extends StatContext {
        ...
        public TerminalNode ELSE() {
            return getToken(FragmentParser.ELSE, 0);
        }

        public TerminalNode IF() {
            return getToken(FragmentParser.IF, 0);
        }
        ...
        public TerminalNode LPAR() {
            return getToken(FragmentParser.LPAR, 0);
        }

        public TerminalNode RPAR() {
            return getToken(FragmentParser.RPAR, 0);
        }
    ...
    public static class BlockStatContext extends StatContext {
        ...
        public TerminalNode RCURLY() {
            return getToken(FragmentParser.RCURLY, 0);
        }

        public TerminalNode LCURLY() {
            return getToken(FragmentParser.LCURLY, 0);
        }
    ...
    public static class ContStatContext extends StatContext {
        public ContStatContext(StatContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode CONTINUE() {
            return getToken(FragmentParser.CONTINUE, 0);
        }

        public TerminalNode SEMI() {
            return getToken(FragmentParser.SEMI, 0);
        }
    ...
    public static class DeclContext extends StatContext {
        public DeclContext(StatContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode ID() {
            return getToken(FragmentParser.ID, 0);
        }

        public TerminalNode ASSIGN() {
            return getToken(FragmentParser.ASSIGN, 0);
        }
    ...
    public static class PrintStatContext extends StatContext {
        public PrintStatContext(StatContext ctx) {
            copyFrom(ctx);
        }

        public List<TerminalNode> ID() {
            return getTokens(FragmentParser.ID);
        }

        public TerminalNode PRINT() {
            return getToken(FragmentParser.PRINT, 0);
        }
        ...
        public List<TerminalNode> COMMA() {
            return getTokens(FragmentParser.COMMA);
        }

        public TerminalNode STRING() {
            return getToken(FragmentParser.STRING, 0);
        }
    ...
    public static class BreakStatContext extends StatContext {
        public BreakStatContext(StatContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode BREAK() {
            return getToken(FragmentParser.BREAK, 0);
        }
    ...
    public static class WhileStatContext extends StatContext {
        public WhileStatContext(StatContext ctx) {
            copyFrom(ctx);
        }
        ...
        public TerminalNode WHILE() {
            return getToken(FragmentParser.WHILE, 0);
        }
    ...
    public static class IdTargetContext extends TargetContext {
        public IdTargetContext(TargetContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class ArrayTargetContext extends TargetContext {
        public ArrayTargetContext(TargetContext ctx) {
            copyFrom(ctx);
        }
        ...
        public TerminalNode RSQ() {
            return getToken(FragmentParser.RSQ, 0);
        }

        public TerminalNode LSQ() {
            return getToken(FragmentParser.LSQ, 0);
        }
    ...
    public static class ArrayExprContext extends ExprContext {
        public ArrayExprContext(ExprContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class InExprContext extends ExprContext {
        ...
        public TerminalNode IN() {
            return getToken(FragmentParser.IN, 0);
        }
    ...
    public static class OrExprContext extends ExprContext {
        ...
        public TerminalNode OR() {
            return getToken(FragmentParser.OR, 0);
        }
    ...
    public static class FieldExprContext extends ExprContext {
        public FieldExprContext(ExprContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode DOT() {
            return getToken(FragmentParser.DOT, 0);
        }
    ...
    public static class BitOrExprContext extends ExprContext {
        ...
        public TerminalNode BIT_OR() {
            return getToken(FragmentParser.BIT_OR, 0);
        }
    ...
    public static class NotExprContext extends ExprContext {
        ...
        public TerminalNode NOT() {
            return getToken(FragmentParser.NOT, 0);
        }
    ...
    public static class AddExprContext extends ExprContext {
        ...
        public TerminalNode PLUS() {
            return getToken(FragmentParser.PLUS, 0);
        }

        public TerminalNode MINUS() {
            return getToken(FragmentParser.MINUS, 0);
        }
    ...
    public static class CompExprContext extends ExprContext {
        public CompExprContext(ExprContext ctx) {
            copyFrom(ctx);
        }
        ...
        public TerminalNode LT() {
            return getToken(FragmentParser.LT, 0);
        }

        public TerminalNode GT() {
            return getToken(FragmentParser.GT, 0);
        }

        public TerminalNode EQ() {
            return getToken(FragmentParser.EQ, 0);
        }

        public TerminalNode NE() {
            return getToken(FragmentParser.NE, 0);
        }
    ...
    public static class BitAndExprContext extends ExprContext {
        ...
        public TerminalNode BIT_AND() {
            return getToken(FragmentParser.BIT_AND, 0);
        }
    ...
    public static class ConstExprContext extends ExprContext {
        public ConstExprContext(ExprContext ctx) {
            copyFrom(ctx);
        }

        public TerminalNode FALSE() {
            return getToken(FragmentParser.FALSE, 0);
        }

        public TerminalNode NUM() {
            return getToken(FragmentParser.NUM, 0);
        }

        public TerminalNode TRUE() {
            return getToken(FragmentParser.TRUE, 0);
        }
    ...
    public static class AndExprContext extends ExprContext {
        ...
        public TerminalNode AND() {
            return getToken(FragmentParser.AND, 0);
        }
    ...
    public static class TypeContext extends ParserRuleContext {
        ...
        public TerminalNode BOOL() {
            return getToken(FragmentParser.BOOL, 0);
        }

        public TerminalNode INT() {
            return getToken(FragmentParser.INT, 0);
        }
